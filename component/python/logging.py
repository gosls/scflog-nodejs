...
def critical(msg, *args, **kwargs):
    ...
    pre-defined format.
    """
    realTimeLogs("CRITICAL %s %s" % (str(msg), " ".join([str(eveObject) for eveObject in args])))
    if len(root.handlers) == 0:
        basicConfig()
...
def error(msg, *args, **kwargs):
    ...
    format.
    """
    realTimeLogs("ERROR %s %s" % (str(msg), " ".join([str(eveObject) for eveObject in args])))
    if len(root.handlers) == 0:
        basicConfig()
...
def info(msg, *args, **kwargs):
    ...
    format.
    """
    realTimeLogs("INFO %s %s" % (str(msg), " ".join([str(eveObject) for eveObject in args])))
    if len(root.handlers) == 0:
        basicConfig()
...
def debug(msg, *args, **kwargs):
    ...
    format.
    """
    realTimeLogs("DEBUG %s %s" % (str(msg), " ".join([str(eveObject) for eveObject in args])))
    if len(root.handlers) == 0:
        basicConfig()
...
def log(level, msg, *args, **kwargs):
    ...
    """
    realTimeLogs("LOG %s %s" % (str(msg), " ".join([str(eveObject) for eveObject in args])))
    if len(root.handlers) == 0:
        basicConfig()
